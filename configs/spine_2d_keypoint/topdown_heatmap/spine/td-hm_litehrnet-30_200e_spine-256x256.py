...
# /root/task2/mmpose/configs/body_2d_keypoint/topdown_heatmap/coco/td-hm_litehrnet-30_8xb64-210e_coco-256x192.py
...
model = dict(
    ...
    init_cfg=dict(
        type='Pretrained',
        checkpoint='/root/task2/weight/litehrnet_30_coco_256x192.pth'),
    head=dict(
        type='HeatmapHead',
        in_channels=40,
        out_channels=17,
